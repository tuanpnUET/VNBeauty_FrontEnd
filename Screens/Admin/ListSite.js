...
const ListSite = (props) => {
    ...
    return(
        <View>
            ...
            >
                <View style={styles.centeredView}>
                    <View style={styles.modalView}>
                        ...
                        secondary
                        onPress={() => [
                            props.navigation.navigate("Edit Site", { item: props}),
                            setModalVisible(false)
                        ]}
                        >
            ...
            <TouchableOpacity
                onPress={() => {
                    props.navigation.navigate("Site Detail", { item: props })
                }}
            ...
            >
                <Image 
                    source={{
                        uri: props.image
                        ? props.image
                        : 'https://www.tranlegroup.com/Uploads/Image/5-ly-do-website-mat-diem-tren-google-1.jpg'
                    }}
                    resizeMode="contain"
                    style={styles.image}
                />
                ...
                <Text style={styles.item}>{props.location}</Text>
                <Text style={styles.item} numberOfLines={1} ellipsizeMode="tail">{props.category.name}</Text>
                <Text style={[styles.item, { color: 'red'}]}>{props.rating}</Text>
            </TouchableOpacity>
        </View>
    )
}
